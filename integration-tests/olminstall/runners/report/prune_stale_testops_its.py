...
Usage:
  python3 integration-tests/olminstall/runners/report/prune_stale_testops_its.py
  python3 integration-tests/olminstall/runners/report/prune_stale_testops_its.py -n my-tenant
"""
